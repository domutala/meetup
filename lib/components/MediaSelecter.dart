...
class MediaSelecter extends StatefulWidget {
  final bool multiple;
  MediaSelecter({this.multiple = false});

  @override
  _MediaSelecterState createState() =>
      _MediaSelecterState(multiple: this.multiple);
}

class _MediaSelecterState extends State<MediaSelecter> {
  final bool multiple;
  _MediaSelecterState({required this.multiple});
